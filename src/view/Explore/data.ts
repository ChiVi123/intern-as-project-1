type NoteType = { id: string; imageSrc: string; content: string };
export type TipType = { id: string; title: string; content: string; position: { top: string; left: string } };

export const notes: NoteType[][] = [
    [
        {
            id: '1fded2ca-18bf-55dc-899f-67a258e138d8id',
            imageSrc: 'imageSrc',
            content: 'Cổng số 1',
        },
        {
            id: '0aff2547-2a52-5ea4-a51f-a3d758fe8528id',
            imageSrc: 'imageSrc',
            content: 'Quầy bán vé',
        },
        {
            id: '59c51bdb-c197-5e75-ba50-317088c48a98id',
            imageSrc: 'imageSrc',
            content: 'Nhà hàng',
        },
    ],
    [
        {
            id: 'c6444463-7af0-5d99-90df-44a3fb3cf24bid',
            imageSrc: 'imageSrc',
            content: 'Cổng số 1A',
        },
        {
            id: '09d223e2-c160-5d96-8b6d-522ce50c4764id',
            imageSrc: 'imageSrc',
            content: 'Bãi xe',
        },
        {
            id: '493876f3-023b-5f6e-a024-0a0aa0aa7a54id',
            imageSrc: 'imageSrc',
            content: 'Quầy lưu niệm',
        },
    ],
    [
        {
            id: '7a4bce12-2d9f-5a78-b784-bee96bfe938fid',
            imageSrc: 'imageSrc',
            content: 'Cổng số 2',
        },
        {
            id: '30e7ffc5-029e-5b79-a8e5-b0d0c10c757did',
            imageSrc: 'imageSrc',
            content: 'Trạm y tế',
        },
        {
            id: '2ac7ad0d-bba0-5576-9057-779632592d6fid',
            imageSrc: 'imageSrc',
            content: 'Nhà vệ sinh',
        },
    ],
...
export const tips: TipType[] = [
    // 01
    {
        id: 'e9f30f0d-0d06-5e26-82e4-2828f53963a4',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '65.8%', left: '21%' },
    },
    // 02
    {
        id: '6e26d140-1e31-57b2-9b78-36f8f7a7a77f',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '21%', left: '66.9%' },
    },
    // 03
    {
        id: '686cb51a-ca5a-58e1-8227-2f42b8bb0693',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '68.9%', left: '16%' },
    },
    // 04
    {
        id: 'a2f6d624-878d-5650-ac66-a37cec5209d3',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '54.5%', left: '87.8%' },
    },
    // 05
    {
        id: 'e318cf21-092c-59d1-b135-7ba93e4617ff',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '63.8%', left: '26.8%' },
    },
    // 06
    {
        id: 'e8b59229-67a9-559d-ad88-8b3948992890',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '79.8%', left: '51.5%' },
    },
    // 07
    {
        id: 'ea9a1175-dcaf-52ef-9d97-5fc89b57d132',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '56%', left: '82.4%' },
    },
    // 08
    {
        id: 'a8ac5c26-52f8-5462-b099-c03d19f1c813',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '57%', left: '75.8%' },
    },
    // 09
    {
        id: 'aa915d2d-9bd2-5f2a-9429-584fdece45ee',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '48%', left: '87%' },
    },
    // 10
    {
        id: 'f1b0008e-0dde-556a-9988-59518f11e144',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '14%', left: '74.8%' },
    },
    // 11
    {
        id: 'f32b5936-aead-5f26-93af-19e98d160367',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '11.4%', left: '87.6%' },
    },
    // 12
    {
        id: '7a7fe7f2-b3ee-55f5-aa9b-5f30aaed02dc',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '36.7%', left: '49.2%' },
    },
    // 13
    {
        id: 'ff6d93f7-22bf-56ab-9f3d-9752fef474b7',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 14
    {
        id: '1f4186ae-c498-5c4c-b216-fdd554583b62',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '86%', left: '32%' },
    },
    // 15
    {
        id: 'ad32fa88-aa62-5068-a313-3e39df404545',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 16
    {
        id: '90a9b9ab-1eaa-550d-bb61-d94e580f7b8a',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 17
    {
        id: '510bf7b1-2480-5027-a44d-30bb5c68b254',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 18
    {
        id: 'd705cced-293e-577b-ada0-6f7927606af4',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 19
    {
        id: '2de7016b-ba6f-5d51-ab5f-2554f6403800',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '39%', left: '66%' },
    },
    // 20
    {
        id: 'b394f57a-d1b1-5cc1-8abb-75266049dc0c',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '47.8%', left: '77.1%' },
    },
    // 21
    {
        id: '5b3eb5e3-23fa-555c-814a-c917d3fbc6dc',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '41.6%', left: '54%' },
    },
    // 22
    {
        id: 'c5cbee3b-8c57-57cb-a89b-8d9bfd451ada',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 23
    {
        id: '47906a5f-ecd6-5488-b0aa-62889eb7ff46',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '86%', left: '44%' },
    },
    // 24
    {
        id: '8f861383-8a45-5de3-a4b1-fd845fbe03c8',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '87%', left: '52%' },
    },
    // 25
    {
        id: '7ebdc53e-d353-5ed2-a6f8-2e0476673dc9',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 26
    {
        id: '3483914d-428b-5859-9d65-d0a97e7e90f3',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '77%', left: '49%' },
    },
    // 27
    {
        id: '904e123b-2e41-5458-a89b-6823152354d7',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 28
    {
        id: '5803a3b2-f81d-5222-a5cc-8b290b2674cb',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 29
    {
        id: '30a67bd4-ad71-52b5-bfc9-1b0b02684c04',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '83%', left: '67%' },
    },
    // 30
    {
        id: '4d73f7ac-0481-5aa8-b5ce-876a3ee68ce0',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 31
    {
        id: 'c4468489-2d67-5e88-9bc2-f6bec3ddf3ed',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 32
    {
        id: 'c8427250-4ff3-503c-b4a8-289b27f47322',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 33
    {
        id: 'bf40350f-9365-5291-bbc4-6b40447244da',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '79%', left: '61.5%' },
    },
    // 34
    {
        id: 'dc42a3fa-8d31-59d5-a51b-a8fc687d5b28',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 35
    {
        id: '99a831a9-e546-5932-ad18-949d3d92c092',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 36
    {
        id: '955dfb8b-7a2f-5655-8b17-3e2eb220a38a',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 37
    {
        id: '54c4694e-aaff-5dac-8c96-24033a8a4059',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 38
    {
        id: 'eb422269-4744-5f49-80dd-c090724a07f6',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '25.4%', left: '82%' },
    },
    // 39
    {
        id: '0912958a-f1b7-50c4-9eaa-98f2c44e1163',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '36%', left: '90%' },
    },
    // 40
    {
        id: '8382ea92-9ef8-513f-adf1-bf2abe06cf6f',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 41
    {
        id: '823405aa-c540-52a3-bdca-c60d9859d8ac',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '47.5%', left: '24.9%' },
    },
    // 42
    {
        id: '4a1f39f8-85bf-5d2a-a2b5-97505ed1eaf2',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 43
    {
        id: '0d73a9fe-601a-56a5-8da6-a368278d5d3c',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 44
    {
        id: '30084552-4994-5b9e-8b61-74428266e698',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 45
    {
        id: '3055c5f5-06f5-520b-995d-a657a6bed0df',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '32%', left: '40%' },
    },
    // 46
    {
        id: '743cfb4b-82d0-5b98-841e-cac73825cad4',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 47
    {
        id: 'dba67f9b-da03-53f3-9849-495b1b1e043e',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '52%', left: '31%' },
    },
    // 48
    {
        id: '27c782e7-637f-54d1-88c3-babbe252d4ca',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 49
    {
        id: '883ff3bc-026a-5dbe-9f75-d2918d004207',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 50
    {
        id: '80bd8cca-ed91-5c25-a1a8-590657b2e71b',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 51
    {
        id: '5b5ac041-a318-5b62-9727-3808ac0ef4bd',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 52
    {
        id: 'a348ac22-8ef1-5909-8898-193a053c22fa',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 53
    {
        id: '791e0751-a622-5ffc-a369-013a45dfefe4',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '68%', left: '90%' },
    },
    // 54
    {
        id: '489d1105-9ff6-5385-a294-56e95c19233b',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 55
    {
        id: '46b98af8-fb85-56e6-b355-5bb0af49d111',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '74%', left: '60%' },
    },
    // 56
    {
        id: '7b110096-5ffe-5a9d-95e7-855d68a31458',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 57
    {
        id: '6882d517-94e9-5482-8088-2d15b3d253d5',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 58
    {
        id: 'bd95145a-3192-5bf1-8c8c-d6bffce4a9c3',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 59
    {
        id: 'acf85a32-afe9-5f5c-bebe-4c5bc2524e2d',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '74%', left: '78%' },
    },
    // 60
    {
        id: '25cf1cbe-7973-59fe-a23f-841a9a3c4ce0',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
        position: { top: '74%', left: '78%' },
    },
    // 61
    {
        id: 'f07519dc-e93f-55d7-b137-9a8b8c5ae04e',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 62
    {
        id: '83cb7597-d0dd-505a-96d6-ee839cc96924',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
    ...
    // 63
    {
        id: 'ced6c956-eb43-5eae-bd4f-1e5e3ef36836',
        title: 'Khu vuc 1',
        content: 'Trò chơi vượt tháp',
